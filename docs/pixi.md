...
6. **Configure Pixi in RDE**
    ...
    - Set the `ROS2.pixiRoot` setting to specify the root directory where Pixi environments are installed. This defaults to `c:\pixi_ws` on Windows and not inferred on Mac or Linux.
